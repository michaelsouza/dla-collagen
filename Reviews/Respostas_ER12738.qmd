...
(R1-5) e a curva de dano (R1-7). Por fim, as três respostas que apenas
reaproveitam texto já escrito (R1-1, R1-6, R2-2).
...
| escada de tamanho $17\times17 \to 181\times181$; $T_s=8192$ $17\times17 \to 141\times141$ | `2026-09-02_confirmacao_secoes_inteiras.md`; `avalanche_ladder_ts128.csv`, `avalanche_ladder_ts8192.csv` |
...
| cilindro largo: $1{,}675 \pm 0{,}023$ ($1{,}5$ década), $1{,}955 \pm 0{,}012$, inclinação $1{,}93 \to 0{,}48$; estrutura local dentro de 2% | `2026-09-01_dimensao_fractal_cilindro_largo.md`; `Reviews/PhaseC_periodic_cylinder/df_wide_cylinders.csv`, `df_local_slopes_wide.csv` |
...
| preenchimento $0{,}82$ (512) $\to 0{,}94$ (8192) | relatório §3.2 e §6 |
...
| número | origem |
|:--|:--|
| quatro observáveis mudam em $\approx 128$; diâmetro em 512; preenchimento não satura | relatório §6 (tabela) |
| $\gamma$ $2{,}83 \to 1{,}91$ em $T_s=8192$ com $m$ | relatório §5.4 |
| Araújo: $d_B$ implícito $0{,}70$–$1{,}07$; 40/50 com $d_B<1$ | relatório §5.5 |
| $N$ varia $3{,}9$ vezes com $T_s$; 25 vezes não move a estatística | `2026-08-29_faixa_dinamica_avalanches.md`; `2026-09-02_confirmacao_secoes_inteiras.md` |
...
$\beta$ vem negativo ou nulo e o erro é de $0{,}09$ a $0{,}25$ em $\varphi$. O
que os dados mostram é simples: o dano preterminal cresce quase linearmente
com $F$ (lei de potência com $\alpha$ entre $0{,}7$ e $1{,}35$ sobre as
realizações ainda inteiras, erro $< 0{,}02$) até só **9% a 34%** do esqueleto,
e então **uma cascata terminal** leva o resto. A subida "exponencial" perto da
ruptura na curva média é a distribuição de $F_{rup}$ entre realizações (CV de
$0{,}12$ a $0{,}29$), não um mecanismo de amplificação de dano. Portanto: a
Eq. (5), $\alpha$ e $\beta$ saem; entram $F_{rup}$ por $T_s$ e $m$, a fração
preterminal, e a curva $\varphi(F/F_{rup})$, que colapsa acima de
$T_s \approx 32$. O que o submetido dizia sobre a força de ruptura crescer com
$T_s$ **se mantém e fica mais forte**: $F_{rup}$ sobe 10 vezes de $T_s=2$ a
8192 (para $m=2$), 83% disso até $T_s = 128$; por molécula do esqueleto,
$2{,}6$ vezes — o efeito da coordenação.
...
## 10. Respostas que reaproveitam o texto atual

### 10.1 R1-1 — Physical grounding of $T_s$
...
Parkinson1995 de $\sim 10$ moléculas por segundo) e `:349` (limitação:
calibrar $T_s$ exige escalas de tempo independentes; a fibrilogênese in vivo é
...
**Linhas do submetido:** 118 (inserir o trecho de `:137` do atual); 261
(inserir a limitação, adaptada de `:349`); 271 (retirar "We speculate that
compactness … aneurysm"; manter a frase de trabalho futuro).

### 10.2 R1-6 — Molecular aspect ratio

**Decisão.** N6 fechado; parágrafo pronto em `Paper/paper_PRE.tex:347`.

**Resposta.** A da carta atual, Point 6.

**Linha do submetido:** 261 (inserir o parágrafo das idealizações antes de
"Fracture is implemented …").

### 10.3 R2-2 — Localized versus equal load sharing
