...
class. The term ``local avalanche'' now refers only to the spatial connectedness
of removed-molecule clusters and does not imply a local-load-sharing mechanism.
